...
import { EmailVerificationTokenModel } from "../../features/auth/database/EmailVerificationTokenModel";
...
export class EmailVerificationTokenRepository implements IEmailVerificationTokenRepository {
  ...
  async markAsUsed(id: string): Promise<void> {
    await EmailVerificationTokenModel.updateOne({ _id: id }, { $set: { used: true } });
  }
