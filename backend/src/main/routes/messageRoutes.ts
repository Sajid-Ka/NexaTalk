...
import { createDirectConversationSchema } from "../../presentation/messages/validators/createDirectConversationValidator";
...
import { getConversationMessagesSchema } from "../../presentation/messages/validators/getConversationMessagesValidator";
import { ValidationSource } from "../../shared/constants/validation.const";
import { sendMessageSchema } from "../../presentation/messages/validators/sendMessageValidator";
import { editMessageSchema } from "../../presentation/messages/validators/editMessageValidator";
import { deleteMessageSchema } from "../../presentation/messages/validators/deleteMessageValidator";
import { markAsReadSchema } from "../../presentation/messages/validators/markAsReadValidator";
const router = Router();
